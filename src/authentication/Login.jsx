    ...
    <div className="mt-10 flex justify-center items-center">
      <div className="md:w-[400px] w-auto bg-white rounded-3xl mx-auto overflow-hidden shadow-xl">
        ...
        <div className="px-10 pt-4 pb-8 bg-white rounded-tr-4xl">
          <h1 className="md:text-2xl text-xl font-semibold text-slate">
            Welcome back!
          </h1>
          ...
          <form className="mt-8" onSubmit={handlerSubmit}>
            ...
            <button
              type="sumbit"
              className="mt-8 px-4 py-2 rounded bg-slate hover:bg-black text-white font-semibold text-center block w-full focus:outline-none cursor-pointer"
            >
              Log In
            </button>
            ...
            <Link to="/signin">
              <p className="my-4 text-center">
                no account?
                <span className="text-crimson mx-2 cursor-pointer hover:underline">
                  SignUp
                </span>
              </p>
            </Link>
