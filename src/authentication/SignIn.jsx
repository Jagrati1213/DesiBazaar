...
function SignIn() {
  return ( 
  <div className="min-h-screen  flex justify-center items-center mt-[90px]">
        <div className="w-[500px] bg-white rounded-3xl mx-auto overflow-hidden shadow-xl">

            <div className="relative h-48 bg-slate rounded-bl-4xl">
            ...
            <div className="px-10 pt-4 pb-8 bg-white rounded-tr-4xl">
                    <h1 className="text-2xl font-semibold text-slate">Hello, Let's Connect!</h1>
                    ...
                    <form className="mt-12" action="" method="POST">
                        ...
                        {/* Submit */}
                        <button type="sumbit" className="mt-20 px-4 py-2 rounded bg-slate hover:bg-black text-white font-semibold text-center block w-full focus:outline-none cursor-pointer" >
                            Sign In
                        </button>
