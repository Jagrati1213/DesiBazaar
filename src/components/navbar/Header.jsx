...
import ELogo from "../../images/logo.jpg";
  ...
  return (
    <header className=" w-full h-[90px] bg-white md:px-8 flex justify-between items-center flex-wrap shadow-lg fixed top-0 z-[110]">
      <div className="md:w-auto w-full max-w-screen-xl flex flex-wrap items-center justify-between px-4">
        ...
        <Link
          to="/"
          className="logo_img flex items-center w-16 h-[-webkit-fill-available]"
        >
          <img
            src={ELogo}
            alt="ajio logo"
            className="w-full object-cover mr-3"
          />
        </Link>
        ...
        <button
          type="button"
          className="inline-flex md:hidden items-center p-2 ml-3 text-slate rounded-lg hover:text-black cursor-pointer"
