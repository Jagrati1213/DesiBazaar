...
function OrderSuccess() {
  ...
  return (
    <main className='mt-[90px] w-full py-10'>
        ...
        <Col  xs={{span: 24 }} xl={{span: 24}} className='p-8 border-b-2 flex justify-center items-center mb-20'>
         ...
         <Result status="success" title="Successfully Order Placed!" subTitle="Order number: 2017182818828182881, we'll get your order soon"
